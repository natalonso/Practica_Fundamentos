...
Como se observa, vemos que los resultados se parecen mucho, de hecho sólo cambiam los coeficientes, pero los p-valores de cada $Beta$ no varian. El $R^2$ y $R^2$ ajustado son los mismos. Más adelante haremos el estudio de inflacción de la varianza (VIF) y decidiremos si nos quedamos con el reescalado. 
